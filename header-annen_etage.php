...
<body <?php body_class(); ?>>
  ...
  <header class="container-fluid annen-site-header paddng110">

    <div class="header-container-annen container d-flex justify-content-between p-0 ">

      <!-- Logo -->
      <?php
      $logo = get_field('logo_annen', 'option');
      if ($logo): ?>
    ...
    <div class="container" id="header" class="d-flex flex-column align-items-center">
      ...
      <nav class="main-nav">
        <?php
        wp_nav_menu(array(
          'theme_location' => 'annen_menu',
          'menu_class' => 'annen-nav',
          'container' => 'nav',
        ));
        ?>
      ...
      <div class="hamburger-menu d-lg-none" aria-label="Toggle menu">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        const header = document.querySelector('.annen-site-header');
