<?php
/**
 * Template Name: meeting room page
 */
            ...
            <div class="container carousel-wrapper position-relative">
                ...
                <div class="swiper suite-swiper">
                    <div class="swiper-wrapper">
                        <?php
                        // Fetch Meeting Room posts
                        $meeting_rooms = new WP_Query(array(
                            'post_type' => 'meeting_room', 
                            'posts_per_page' => -1,
                            'orderby' => 'menu_order',
                            'order' => 'ASC',
                        ));

                        if ($meeting_rooms->have_posts()):
                            while ($meeting_rooms->have_posts()):
                                $meeting_rooms->the_post();
