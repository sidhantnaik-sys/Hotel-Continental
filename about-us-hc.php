<?php
/**
 * Template Name:  about-us-hc page
 */
        ...
        <div class="container carousel-wrapper position-relative">
            ...
            <div class="swiper suite-swiper">
                <div class="swiper-wrapper">
                    <?php
                    // Fetch About Us HC posts
                    $about_us_hc = new WP_Query(array(
                        'post_type' => 'about_us_hc', // ✅ Custom post type slug
                        'posts_per_page' => -1,            // fetch all, or set a number
                        'orderby' => 'menu_order',
                        'order' => 'ASC',
                    ));

                    if ($about_us_hc->have_posts()):
                        while ($about_us_hc->have_posts()):
                            $about_us_hc->the_post();
                            // Fetch fields
                            $title = get_the_title();
