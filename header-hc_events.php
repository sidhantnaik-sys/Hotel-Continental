...
<body <?php body_class(); ?>>
  ...
  <header class="container-fluid site-header-hc">

    <div class="header-container container d-flex justify-content-between ">

      <!-- Logo -->
      <?php
      $logo = get_field('footer_contact_title_img_hc', 'option');
      if ($logo): ?>
          ...
          <div class="row w-100">
            ...
            <div class="col-md-4">
              <nav class="main-menu">
                <?php
                wp_nav_menu([
                  'theme_location' => 'mega-menu-hc-events',
                  'menu_class' => '',
                  'container' => false,
                ]);
                ?>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        const header = document.querySelector('.site-header-hc');
